...
Brain\Monkey\Functions\when("plugin_dir_path")->justReturn(
    dirname(__DIR__) . "/"
);
Brain\Monkey\Functions\when("plugin_dir_url")->justReturn(
    "http://example.com/wp-content/plugins/pagepatrol/"
);
Brain\Monkey\Functions\when("plugin_basename")->justReturn(
    "pagepatrol/pagepatrol.php"
);
...
Brain\Monkey\Functions\when("wp_remote_retrieve_body")->justReturn(
    wp_json_encode(["id" => "123"])
);
Brain\Monkey\Functions\when("wp_remote_retrieve_response_code")->justReturn(
    200
);
...
Brain\Monkey\Functions\when("admin_url")->justReturn(
